 ...
 * {@hide}
 */
public class dualRIL extends RIL {

    public dualRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
    }

    public dualRIL(Context context, int preferredNetworkType,
